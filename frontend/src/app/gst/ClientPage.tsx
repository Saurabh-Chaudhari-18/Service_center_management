  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <>
          {/* Net Payable Hero */}
          <Card className="border-primary-200 bg-primary-50/50 dark:border-primary-900/60 dark:bg-primary-950/20">
            <p className="text-sm font-medium text-neutral-600 dark:text-neutral-300">Net GST Payable</p>
            <p className="mt-1 text-4xl font-bold text-neutral-900 dark:text-white">{fmt(data.net_payable?.total)}</p>
            <div className="mt-4 flex gap-6 text-sm text-neutral-600 dark:text-neutral-300">
            ...
            <div className="mt-4 flex gap-3 flex-wrap">
              <Link href="/gst/gstr1" className="inline-flex">
                <Badge variant={data.filing_status?.gstr1_filed ? "success" : "warning"}>
              ...
              <Link href="/gst/gstr3b" className="inline-flex">
                <Badge variant={data.filing_status?.gstr3b_filed ? "success" : "warning"}>
