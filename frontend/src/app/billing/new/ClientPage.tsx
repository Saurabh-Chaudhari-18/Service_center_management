...
function CreateInvoiceContent() {
  ...
  if (isLoadingJob) {
    return (
      <AppLayout>
        <Header title="Create Invoice" subtitle="Loading job details" />
        <PageShell width="wizard" className="flex min-h-[60vh] items-center justify-center">
...
export default function CreateInvoicePage() {
  return (
    <Suspense
      fallback={
        <AppLayout>
          <Header title="Create Invoice" subtitle="Loading invoice builder" />
          <PageShell width="wizard" className="flex min-h-[60vh] items-center justify-center">
            <Loader2 className="w-8 h-8 text-primary-600 animate-spin" />
