    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap gap-6">
          <Checkbox label="Enable SMS" {...register("sms_enabled")} />
          <Checkbox label="Enable WhatsApp" {...register("whatsapp_enabled")} />
          <Checkbox
            label="GST Registered Branch"
            containerClassName="rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 dark:border-amber-900/60 dark:bg-amber-950/30"
