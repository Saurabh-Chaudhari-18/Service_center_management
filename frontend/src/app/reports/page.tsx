...
// =====================================================
// Backend returns: { from_date, to_date, branches: [...], daily_breakdown: [...], totals: { total_revenue, total_collected, total_outstanding, total_invoices, total_tax } }
...
// =====================================================
// Backend returns: { total_pending, urgent_count, overdue_count, by_status: [{ status, count }], by_branch: [...], by_age: {...} }
...
// =====================================================
// Backend returns: { from_date, to_date, technicians: [{ technician_id, technician_name, jobs_completed, jobs_in_progress, total_assigned }] }
...
// =====================================================
// Backend returns: { from_date, to_date, top_items: [...], by_category: [...], daily_usage: [...], totals: {...} }
...
// =====================================================
// Backend returns: { from_date, to_date, total_customers, new_customers, top_customers: [{ job__customer, job__customer__first_name, job__customer__last_name, job__customer__mobile, total_revenue, invoice_count }] }
...
// =====================================================
// Backend returns: { from_date, to_date, summary: { total_taxable, total_cgst, total_sgst, total_igst, total_tax, total_value, invoice_count }, by_rate: [...], by_supply_type: [...] }
...
// =====================================================
// Backend returns: { total_items, items: [{ id, name, sku, branch, category, quantity, threshold, shortage, cost_price }] }
