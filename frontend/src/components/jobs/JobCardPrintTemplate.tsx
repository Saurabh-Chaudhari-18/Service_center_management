...
export function JobCardPrintTemplate({ job, branchDetails }: JobCardPrintTemplateProps) {
  ...
  return (
    <PrintPortal>
      ...
      />
      <div className="paper-doc bg-white text-black p-6 text-[11pt] leading-[1.35] print:p-4 print:text-[10pt] print:leading-[1.3]">
        {/* ============================================= */}
        {/* COMPANY HEADER with Brand Logos */}
        {/* ============================================= */}
        <div className="print-header print-section border-2 border-black p-3 mb-3 print:p-2 print:mb-2">
        ...
        {/* ============================================= */}
        <div className="print-grid print-section grid grid-cols-2 gap-4 mb-3 print:gap-2 print:mb-2">
        ...
        <div className="print-section border border-black p-2 mb-3 print:mb-2 terms-text">
          ...
          <div className="space-y-1 text-[9pt] leading-[1.4] text-justify">
            <p>
